...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wangyuandong/YDFileManager'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wangyuandong' => 'chong2vv@163.com' }
  s.source           = { :git => 'https://github.com/wangyuandong/YDFileManager.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'YDFileManager' => ['YDFileManager/Assets/*.png']
  # }
